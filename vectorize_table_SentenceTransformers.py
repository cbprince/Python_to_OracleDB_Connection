...
#embedding_model = \sentence-transformers/paraphrase-MiniLM-L3-
v2\ 
...
transformers/average_word_embeddings_glove.6B.300d\ 
#embedding_model = \sentence-
transformers/average_word_embeddings_komninos\ 
...
later\) 
    ...
    with connection.cursor() as cursor: 
        ...
        for id_val, info in cursor.execute(query_sql): 
            # Convert to input string format for Sentence 
Transformers 
            data = f\[ {info} ]\ 
        ...
        print(f\\nAdded {len(binds)} vectors to the table using 
